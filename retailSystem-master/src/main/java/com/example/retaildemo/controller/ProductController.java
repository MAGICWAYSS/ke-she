...
public class ProductController {
    ...
    public ResultVO getListById(@RequestParam Integer id){
        ResultVO getlist = productService.getListById(id);
        return getlist;
    }
    @GetMapping("/productbyName")
    @ApiOperation("后台查询")
    public List<ProductVO> getListByName(@RequestParam String name){
