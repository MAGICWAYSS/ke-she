...
/*        writer.addHeaderAlias("username", "用户名");
    ...
    public ResultVO changeinfo(@RequestBody Users users){
        ResultVO resultVO=usersService.changeInfo(users.getUsername(),users.getUserId(),users.getPassword());
        return resultVO;
    }
}
